...
module.exports = {
    ...
    async store(req, res) {
        try {
            ...
            return res.status(404).json({ error: `Erro ao cadastrar classificação. Erro: ${error}` });
        }
    },
    ...
    async update(req, res) {
        try {
            ...
            return res.status(404).json({ error: `Erro ao atualizar classificação.` });
        } catch (error) {
            return res.status(404).json({ error: `Erro ao atualizar classificação. Erro: ${error}` });
        }
    },
    ...
    async destroy(req, res) {
        try {
            ...
            return res.status(404).json({ error: `Erro ao deletar classificação. Erro: ${error}` });
        }
    }
};