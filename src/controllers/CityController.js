...
module.exports = {
    ...
    async store(req, res) {
        try {
            ...
            return res.status(404).json({ error: `Erro ao cadastrar cidade. Erro: ${error}` });
        }
    },
    ...
    async update(req, res) {
        try {
            ...
            return res.status(404).json({ error: `Erro ao atualizar cidade.` });
        } catch (error) {
            return res.status(404).json({ error: `Erro ao atualizar cidade. Erro: ${error}` });
        }
    },
    ...
    async destroy(req, res) {
        try {
            ...
            return res.status(404).json({ error: `Erro ao deletar cidade. Erro: ${error}` });
        }
    }
};