...
module.exports = {
    ...
    async show(req, res) {
        ...
        if (countries === null) {
            return res.status(404).json({ error: `Paiz não encontrado!` });
        }
    ...
    async store(req, res) {
        try {
            ...
            return res.status(404).json({ error: `Erro ao cadastrar paiz. Erro: ${error}` });
        }
    },
    ...
    async update(req, res) {
        try {
            ...
            return res.status(404).json({ error: `Erro ao atualizar paiz.` });
        } catch (error) {
            return res.status(404).json({ error: `Erro ao atualizar paiz. Erro: ${error}` });
        }
    },
    ...
    async destroy(req, res) {
        try {
            ...
            return res.status(404).json({ error: `Erro ao deletar paiz. Erro: ${error}` });
        }
    }
};